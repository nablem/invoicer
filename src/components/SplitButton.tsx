...
export default function SplitButton({ mainAction, mainHref, mainLabel, dropdownItems, color, mainActionDisabled, mainTarget }: SplitButtonProps & { mainActionDisabled?: boolean }) {
        ...
        <div style={{ display: "inline-flex", position: "relative", verticalAlign: "middle" }} ref={dropdownRef}>
            {mainHref ? (
                mainActionDisabled ? (
                    ...
                    <Link href={mainHref} style={buttonStyle as any} target={mainTarget}>
                        {mainLabel}
                    </Link>
                )
            ) : (
